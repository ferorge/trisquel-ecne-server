...
# Endurecimiento BOOT-5264 systemd-initctl

## __Autoría y licencia__
###### Endurecimiento BOOT-5264 systemd-initctl © 2025 por \~ferorge
...
sed -i 's/User=root/User=daemon/g' $SERVICE
sed -i 's/Group=root/Group=daemon/g' $SERVICE
