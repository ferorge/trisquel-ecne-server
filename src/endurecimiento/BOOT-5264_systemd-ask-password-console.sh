...
# Endurecimiento BOOT-5264 systemd-ask-password-console

## __Autoría y licencia__
###### Endurecimiento BOOT-5264 systemd-ask-password-console © 2025 por \~ferorge
...
UNIT='systemd-ask-password-console'
